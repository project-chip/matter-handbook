...
| CTP      | Certification transfer program. This program is used to allow companies to white-label devices that were previously certified by another member company. More information on the [Certification Transfer Program](https://csa-iot.org/certification/transfer-program/) can be found on the website.|
...
| VID      | Vendor identifier. VIDs are allocated by the Alliance (see [Membership](../Certification/certifying-a-product/membership/))|
