...
#### Test-Net Public ONs TEST

| Host Owner       | Region       | Web User Interface                                                                  | URL for API                 | REST    | RPC     | gRPC  |
| ---------------- | ------------ | ----------------------------------------------------------------------------------- | --------------------------- | ------- | ------- | ----- |
| The Alliance ON  | US, EU       | [https://testnet.iotledger.io](https://testnet.iotledger.io)<br>(hosted by Comcast) | on.test-net.dcl.csa-iot.org |  443    | 26657   | 8443  |
