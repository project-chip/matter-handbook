...
Organizations across the Matter ecosystem publish tutorials, courses, documentation, and example projects for developers. These resources complement the [official Matter SDK documentation](https://project-chip.github.io/connectedhomeip-doc/index.html) and the material in this handbook.

!!!base About These Resources
The Matter specification, SDK documentation, and Connectivity Standards Alliance policies remain the sources of truth. Each organization maintains its own content.
!!!
